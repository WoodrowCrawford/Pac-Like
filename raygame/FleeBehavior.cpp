...
void FleeBehavior::draw(Agent* owner)
{
...
void FleeBehavior::updatePath(Agent* owner)
{
	updatePath(owner, m_target->getWorldPosition());
}

void FleeBehavior::updatePath(Agent* owner, MathLibrary::Vector2 destination)
{
...
MathLibrary::Vector2 FleeBehavior::findDestination(Agent* owner)
{
